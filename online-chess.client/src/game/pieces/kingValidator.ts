...
export default class KingValidator extends BasePieceValidator{
    ...
    validKingSideCastling(x: number, y: number): IValidMove | null {
        ...
        const bishopSquare = this.board[kingOrigX + (this.boardOrientationIsWhite ? 1 : -1)][y];
        const knightSquare = this.board[kingOrigX + (this.boardOrientationIsWhite ? 2 : -2)][y];
        ...
        const isUnderAttack = { x: kingOrigX + (this.boardOrientationIsWhite ? 1 : -1), y, isCapture: false };
        const _this = this;
        ...
        return { x: kingOrigX + (this.boardOrientationIsWhite ? 2 : -2), y, isCapture: false };
    }
    ...
    validQueenSideCastling(x: number, y: number): IValidMove | null {
        ...
        // 3. if there are no blockage (knight, bishop)
        const queenSquare = this.board[kingOrigX + (this.boardOrientationIsWhite ? -1 : 1) ][y];
        const bishopSquare = this.board[kingOrigX + (this.boardOrientationIsWhite ? -2 : 2) ][y];
        const knightSquare = this.board[kingOrigX + (this.boardOrientationIsWhite ? -3 : 3) ][y];
